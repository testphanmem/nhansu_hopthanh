...
<script>
    ...
    function SCV_OpenUploadModal(btnElement, currentLink, rootId, onlyLink = false) {
        ...
        // NÂNG CẤP BẢO MẬT HIỂN THỊ: Tự động trỏ chuột vào ô nhập liệu để chống liệt nút
        if(onlyLink) {
            setTimeout(function() {
                const txtInput = document.getElementById('txtDirectLinkCV');
    ...
    function doUploadCV() {
       ...
       if (mode === 'link') {
           ...
           if (wMode === 'append' && LINK_CAN_XOA_CV && LINK_CAN_XOA_CV.trim() !== "") {
               ...
               if(typeof google !== 'undefined' && typeof google.script.run.SCV_deleteFileByUrl === 'function') {
    ...
    function handleUpResultCV(res, st, btn) {
       if (res.success) { 
           ...
           if (GLOBAL_BTN_TRIGGER) {
               // Bắt thông tin cho form Đánh Giá nếu có
               ...
               // Cập nhật giao diện nếu gọi từ form khác
               ...
               // Hiển thị lại Ghim trên form Đánh giá
