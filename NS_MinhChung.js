<style>
  ...
  /* NÂNG CẤP BẢO MẬT HIỂN THỊ: Ép z-index lên 105055 để không bị Bootstrap Modal che */
...
<script>
    ...
    function SCV_OpenUploadModal(btnElement, currentLink, rootId, onlyLink = false) {
        ...
        // Tự động đẩy con trỏ chuột vào ô nhập liệu để chống liệt nút do form cũ đè
        if(onlyLink) {
            setTimeout(function() {
